...
--%>
	...
	<div class="container py-3">
		...
		<div>
			...
			<textarea class="form-control w-75 mt-2" type="text" placeholder="Type here..." name="post-body" id="post-body" required></textarea>
	...
	<div id="search-result-container" class="container py-3">
		<ul id="search-result" class="list-group">
			<h3>Feed</h3>		
			<%for (Post p: lst){ %>
				<li class='list-group-item w-75 li-post'>
					...
					<input type='button' class='btn btn-warning delete-id' value='delete' data-id='<% out.println(p.id);%>'>
				</li>
				<br>
			<%} %>	
